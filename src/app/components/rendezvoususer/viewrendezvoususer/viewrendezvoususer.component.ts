...
@Component({
  selector: 'app-viewrendezvoususer',
  templateUrl: './viewrendezvoususer.component.html',
  styleUrls: ['./viewrendezvoususer.component.css']
})
export class ViewrendezvoususerComponent implements OnInit {
